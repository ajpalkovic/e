...
apt-get install libgtk2.0-dev build-essential libwxgtk2.8-dev libglib2.0-dev libatk1.0-dev libcurl4-openssl-dev libxml2-dev libxslt1-dev libsqlite3-dev libicu-dev libjpeg62-dev flex bison gperf python-dev
# bakefile 
